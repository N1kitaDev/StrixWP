...
##### Кастомные виджеты с выбором источника данных
Виджеты теперь поддерживают два типа источников данных:

###### 🌐 Google Business Profile (по умолчанию)
- Отзывы из Google My Business
- Требует настройки Account ID и Location ID
- Синхронизированные данные в реальном времени

###### 💬 Custom Reviews
- Отзывы, оставленные посетителями сайта
- Работает без дополнительных настроек API
- Управление через админку WordPress

#### Кастомные виджеты
1. Перейдите в **Google Reviews** > **Review Widgets**
2. Нажмите **Add New Widget** для создания нового виджета
3. **📊 Data Source** - выберите источник отзывов:
   - **🌐 Google Business Profile** - отзывы из Google My Business
   - **💬 Custom Reviews** - отзывы, оставленные на вашем сайте
4. **🎨 Layout & Design** - выберите тип лэйаута визуально:
   - 📝 **List** - вертикальный список
   - 🔳 **Grid** - сетка отзывов
   - 🎠 **Slider** - интерактивная карусель
   - 🏷️ **Badge** - компактный бейдж с рейтингом
   - 📋 **Popup** - отзывы в модальном окне
5. **⚙️ Display Options** - настройте параметры отображения:
   - Количество отзывов
   - Сортировка (новые/старые/по рейтингу)
   - Переключатели для показа/скрытия элементов
6. **🔍 Filters & Sorting** - расширенные фильтры:
   - Минимальный рейтинг
