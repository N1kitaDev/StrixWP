...
<div class="strix-box ti-promobox-with-image">
<div class="strix-box-header">1. <?php echo esc_html(__('Email Campaigns', 'wp-reviews-plugin-for-google')); ?></div>
<div class="strix-promobox-body">
<div class="strix-promobox-text">
...
<br /><br />
<a href="https://www.strix.io/?a=sys&c=wp-getmore-email&url=/features-list/collect-reviews/email-campaigns/" target="_blank" class="strix-btn"><?php echo esc_html(__('Create Your Review Collector Campaign Now!', 'wp-reviews-plugin-for-google')); ?></a>
</div>
<div class="strix-promobox-image">
<img src="<?php echo esc_url($pluginManagerInstance->get_plugin_file_url('static/img/review-collection-sm.png')); ?>" />
</div>
</div>
</div>
<div class="strix-box ti-promobox-with-image">
<div class="strix-box-header">2. <?php echo esc_html(__('Review Collector NFC Cards', 'wp-reviews-plugin-for-google')); ?></div>
<div class="strix-promobox-body">
<div class="strix-promobox-text">
<?php
/* translators: %s: 130 */
...
<br /><br />
<a href="https://www.strix.io/?a=sys&c=wp-getmore-nfc&url=/features-list/collect-reviews/nfc-cards/" target="_blank" class="strix-btn"><?php echo esc_html(__('Order Your NFC Cards Today!', 'wp-reviews-plugin-for-google')); ?></a>
</div>
<div class="strix-promobox-image">
...
<div class="strix-box ti-promobox-with-image ti-qr-code-promo">
<div class="strix-box-header">3. <?php echo esc_html(__('QR Codes', 'wp-reviews-plugin-for-google')); ?></div>
<div class="strix-promobox-body">
<div class="strix-promobox-text">
...
<br /><br />
<a href="https://www.strix.io/?a=sys&c=wp-getmore-qr&url=/features-list/collect-reviews/qr-codes/" target="_blank" class="strix-btn"><?php echo esc_html(__('Create Your Custom QR Code!', 'wp-reviews-plugin-for-google')); ?></a>
</div>
<div class="strix-promobox-image">
...
<div class="strix-box ti-promobox-with-image">
<div class="strix-box-header">4. <?php echo esc_html(__('WooCommerce Integrations', 'wp-reviews-plugin-for-google')); ?></div>
<div class="strix-promobox-body">
<div class="strix-promobox-text">
...
<br /><br />
<?php echo esc_html(__('This tool enables automated review requests after purchases, ensuring a steady flow of feedback for your business. Seamlessly integrate your online shop with strix and watch the reviews roll in without lifting a finger.', 'wp-reviews-plugin-for-google')); ?>
<br /><br />
<a href="https://wordpress.org/plugins/customer-reviews-collector-for-woocommerce/" target="_blank" class="strix-btn"><?php echo esc_html(__('Explore Our WooCommerce Integrations Now!', 'wp-reviews-plugin-for-google')); ?></a>
</div>
<div class="strix-promobox-image">
