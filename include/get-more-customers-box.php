...
?>
<h1 class="strix-header-title ti-mt-2"><?php echo esc_html(__('Want to get more customers?', 'wp-reviews-plugin-for-google')); ?></h1>
<div class="strix-box">
<div class="strix-box-header"><?php echo esc_html(__('Increase SEO, trust and sales using customer reviews.', 'wp-reviews-plugin-for-google')); ?></div>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton($tiCampaign1)); ?>
<ul class="strix-seo-list">
<li>
<strong><?php echo esc_html(__('Display unlimited number of reviews', 'wp-reviews-plugin-for-google')); ?></strong><br />
<?php echo esc_html(__('You can test strix with 10 reviews in the free version. Upgrade to Business to display ALL the reviews received. Be the undisputed customer choice in your industry!', 'wp-reviews-plugin-for-google')); ?>
</li>
<li>
...
<?php echo esc_html(__('Wordpress cannot update reviews, but strix can! As soon as you get a new review, strix Business can automatically add it to your website. Customers love fresh reviews!', 'wp-reviews-plugin-for-google')); ?>
</li>
</ul>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton($tiCampaign2)); ?>
<div class="strix-special-offer">
