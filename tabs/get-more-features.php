...
?>
<h1 class="strix-header-title"><?php echo esc_html(__('Get more Features', 'wp-reviews-plugin-for-google')); ?></h1>
<div class="strix-box">
<div class="strix-box-header"><?php echo esc_html(__('Skyrocket Your Sales with Customer Reviews', 'wp-reviews-plugin-for-google')); ?></div>
<p class="strix-bold">
<?php
/* translators: %s: user number (800.000) */
echo esc_html(sprintf(__('%s+ WordPress websites use strix to embed reviews fast and easily.', 'wp-reviews-plugin-for-google'), '800.000'));
?><br />
<?php echo esc_html(__('Increase SEO, trust and sales using customer reviews.', 'wp-reviews-plugin-for-google')); ?>
</p>
<div class="strix-section-title"><?php echo esc_html(__('Top Features', 'wp-reviews-plugin-for-google')); ?></div>
