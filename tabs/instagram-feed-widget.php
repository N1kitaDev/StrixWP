...
?>
<div class="strix-container ti-narrow-page">
<h1 class="strix-header-title">Instagram Feed Widget</h1>
<div class="strix-preview-boxes-container">
<div class="strix-full-width">
<div class="strix-box">
<div class="strix-box-inner">
<div class="strix-box-header"><?php
/* translators: %s: Feed */
echo esc_html(sprintf(__('Display your %s with our free Widgets!', 'wp-reviews-plugin-for-google'), ' Feed'));
?></div>
<img class="strix-mb-2" src="<?php echo esc_url($pluginManagerInstance->get_plugin_file_url('static/img/instagram-feed-widget.jpg')); ?>" />
<a class="strix-btn" href="https://wordpress.org/plugins/social-photo-feed-widget" target="_blank"><?php
...
?></a>
<div class="strix-section-title"><strong><?php echo esc_html(__('Free features', 'wp-reviews-plugin-for-google')); ?></strong></div>
