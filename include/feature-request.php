...
wp_mail('support@strixmedia.ru', $subject, $message, [ 'From: '. $email, 'Content-Type: text/html; charset=UTF-8' ]);
}
exit;
}
?>
<div class="strix-box ti-feature-request">
<div class="strix-box-inner">
<div class="strix-box-header"><?php echo esc_html(__('Missing a feature?', 'wp-reviews-plugin-for-google')); ?></div>
<p>
...
<textarea class="strix-form-control" name="description" rows="3" placeholder="<?php echo esc_html(__('The more detail you can share, the better.', 'wp-reviews-plugin-for-google')); ?>"></textarea>
</div>
<div class="strix-form-group">
<label>
...
<textarea class="strix-form-control" name="attachments" rows="3" placeholder="<?php echo esc_html(__('URL of images (each on a separate line)', 'wp-reviews-plugin-for-google')); ?>"></textarea>
</div>
<div class="strix-form-group">
<label><?php echo esc_html(__('Please describe your current workaround', 'wp-reviews-plugin-for-google')); ?></label>
<textarea class="strix-form-control" name="workaround" rows="3" placeholder="<?php echo esc_html(__('If you have one - otherwise leave it blank.', 'wp-reviews-plugin-for-google')); ?>"></textarea>
</div>
<div class="strix-form-group">
<label><?php echo esc_html(__('Your name', 'wp-reviews-plugin-for-google')); ?></label>
<input type="text" class="strix-form-control" name="name" placeholder="<?php echo esc_html(__('The more detail you can share, the better.', 'wp-reviews-plugin-for-google')); ?>" />
</div>
<div class="strix-form-group">
<label><?php echo esc_html(__('Your email address', 'wp-reviews-plugin-for-google')); ?>*</label>
<input type="text" class="strix-form-control" name="email" value="<?php echo esc_attr($current_user->user_email); ?>" />
</div>
